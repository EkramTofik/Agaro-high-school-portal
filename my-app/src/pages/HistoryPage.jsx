...
import { Award, FileText, ArrowRight, Trophy, Users, X } from "lucide-react";
import api from "../api/axios";

export default function HistoryPage() {
  const [featuredAlumnus, setFeaturedAlumnus] = useState(null);
  ...
  useEffect(() => {
    ...
    Promise.all([api.get("/school"), api.get("/alumni"), api.get("/staff", { params: { isDistinguished: true, isActive: true } }), api.get("/honorRoll", { params: { sort: "rank" } })])
      .then(([schoolRes, alumniRes, staffRes, honorRollRes]) => {
        const schools = getItems(schoolRes);
        const alumniItems = getItems(alumniRes).filter(Boolean);
        setSchool(schools[0] || null);
        setAlumni(alumniItems);
        setFeaturedAlumnus(alumniItems.find((item) => item.isFeatured) || alumniItems[0] || null);
        setArchitects(getItems(staffRes).filter(Boolean).slice(0, 2));
        setHonorRoll(getItems(honorRollRes).filter(Boolean));
      })
      .catch(() => {
        setFeaturedAlumnus(null);
        setSchool(null);
        setAlumni([]);
        setArchitects([]);
        setHonorRoll([]);
        ...
        <main className="flex-1 px-6 lg:pl-16 py-8 lg:py-12">
          ...
          <section id="hall-of-fame" className="mb-24 lg:mb-32 pt-8">
            <div className="text-center mb-16 max-w-2xl mx-auto">
              ...
              <h1 className="font-serif text-4xl md:text-5xl font-bold text-[#033327] mb-6">
                The Hall of Fame
              </h1>
              <p className="text-[13px] text-gray-500 italic font-serif leading-relaxed max-w-xl mx-auto">
                Throughout its history, {school?.name || "Agaro High School"} has seen leaders, scholars, and
                innovators who have shaped the nation. The living archive
                preserves the excellence we nurture. The Hall of Fame stands as
                proof.
              </p>
            </div>
            ...
            <div className="flex flex-col md:flex-row rounded-[2rem] overflow-hidden max-w-4xl mx-auto shadow-[0_4px_20px_rgba(0,0,0,0.05)] border border-[#e5e1d8]">
              ...
              <div className="md:w-1/2 relative bg-gray-200 min-h-[300px]">
                ...
                <img
                  src={featuredAlumnus?.imageUrl || school?.heroImageUrl}
                  className="w-full h-full object-cover grayscale opacity-90"
                  alt="Historical profile unavailable"
                />
              ...
              <div className="md:w-1/2 bg-[#dce8de] p-10 md:p-12 flex flex-col justify-center">
                <p className="text-[8px] font-bold text-[#86a78f] uppercase tracking-widest mb-1">
                  FOUNDER & HEADMISTRESS
                </p>
                <h3 className="font-serif text-[1.75rem] font-bold text-[#033327] mb-1">
                  {featuredAlumnus?.fullName || "No featured alumnus available"}
                </h3>
                <p className="text-[9px] text-[#033327]/60 font-bold uppercase tracking-wider mb-8">
                  Served 1965 - 1982 | Addis Ababa, Ethiopia
                </p>

                <div className="border-l-2 border-[#b5985b] pl-5 mb-6">
                  <p className="font-serif italic text-[13px] text-[#033327] leading-relaxed">
                    "True education transcends the classroom. It is the
                    steadying force that shapes a nation, and the gentle hand
                    that guides an individual."
                  </p>
                </div>

                <p className="text-[11px] text-[#033327]/80 leading-relaxed mb-8">
                  {school?.description || "Agaro High School was founded with the vision"}
                  {" "}of establishing an institution that would cultivate not just
                  academic rigor, but profound philosophical inquiry. Her early
                  initiatives shaped the foundational principles of study.
                </p>
          ...
          <section id="alumni" className="mb-24 lg:mb-32 pt-8">
            <div className="max-w-4xl mx-auto">
              <div className="flex items-center justify-between border-b border-[#e5e1d8] pb-4 mb-10">
                <h2 className="font-serif text-2xl font-bold text-[#033327]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                {alumni.filter((item) => item.isFeatured !== false).slice(0, 6).map((alumnus) => (
                  <div
                    key={alumnus._id}
                    className="bg-[#F6F4EB] border border-[#e5e1d8] p-7 rounded-2xl relative shadow-[inset_0_2px_4px_rgba(255,255,255,1),0_2px_10px_rgba(0,0,0,0.02)] hover:border-[#b5985b] transition-colors group flex flex-col"
                  >
                    ...
                    <h3 className="font-serif text-[15px] font-bold text-[#033327] mb-1.5">
                      {alumnus.fullName}
                    </h3>
                    <p className="text-[7px] font-bold text-[#62b993] uppercase tracking-[0.2em] mb-4">
                      {alumnus.profession || "ALUMNUS"}
                    </p>
                    <p className="text-[10px] text-gray-500 leading-relaxed flex-1">
                      {alumnus.bio || alumnus.company || "Distinguished member of the Agaro community."}
                    </p>
                  </div>
                ))}
              </div>
                ...
                <div className="flex flex-col md:flex-row items-center gap-10 md:gap-14">
                  ...
                  <div>
                    <div className="flex flex-col md:flex-row md:items-end gap-2 md:gap-4 mb-4">
                      <h3 className="font-serif text-[1.75rem] font-bold text-[#033327] leading-none">
                        {architect.fullName}
                      </h3>
                      <span className="text-[8px] font-bold text-[#b5985b] uppercase tracking-[0.2em] md:mb-1">
                        {architect.title}
                      </span>
                    </div>
                    <p className="font-serif italic text-sm text-[#033327] leading-relaxed mb-5 border-l-2 border-[#b5985b] pl-4">
                      ...
                      of a fire. The laboratory was our hearth and logic."
                    </p>
                    <p className="text-[11px] text-gray-500 leading-relaxed max-w-xl">
                      {architect.bio || "Faculty profile available through the school directory."}
                    </p>
                  </div>
                </div>
                ))}
                {!architects.length && <p className="text-center text-sm text-gray-500">No distinguished faculty profiles are available.</p>}
              </div>
            </div>
          </section>
          ...
          <section id="archives" className="mb-12 pt-8">
            ...
            <div className="max-w-4xl mx-auto mb-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                <div className="bg-[#e9e6df] rounded-[2rem] p-8 flex flex-col shadow-sm border border-[#e5e1d8]">
                  ...
                  <h3 className="text-[11px] font-bold text-[#033327] uppercase tracking-[0.15em] mb-3">
                    The PTA Council
                  </h3>
                  <p className="text-[10px] text-gray-600 leading-relaxed mb-8 flex-1">
                    The unsung heroes of our developmental programs, funding new
                    laboratories, library extensions, and student welfare
                ...
                <div className="bg-[#243e36] rounded-[2rem] p-8 flex flex-col shadow-lg border border-[#1a2d27]">
                  ...
                  <h3 className="text-[11px] font-bold text-white uppercase tracking-[0.15em] mb-3">
                    Student Guild
                  </h3>
                  <p className="text-[10px] text-white/70 leading-relaxed mb-8 flex-1">
                    Pioneering peer mentorship and organizing community service
                    campaigns that cemented the school's reputation as a civic
                    pillar.
                  </p>
                </div>
                ...
                <div className="bg-[#f0c356] rounded-[2rem] p-8 flex flex-col shadow-md border border-[#e5b23d]">
                  ...
                  <p className="text-[10px] text-[#033327]/80 leading-relaxed mb-8 flex-1">
                    From regional football cups to national athletics
                    championships, our athletes have brought home glory and
                    fostered unparalleled school spirit.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto mb-20">
              <div className="bg-[#F6F4EB] border border-[#e5e1d8] rounded-[2.5rem] p-10 md:p-14 shadow-sm">
                <div className="text-center mb-12">
                  <h2 className="font-serif text-xl font-bold text-[#033327] tracking-[0.15em] uppercase mb-2">
                    The National Honor Roll
                  </h2>
                ...
                <div className="w-full overflow-x-auto">
                  <table className="w-full text-left text-[11px] min-w-[600px]">
                    ...
                    <tbody className="text-gray-600">
                      {honorRoll.slice(0, 4).map((row) => (
                        <tr key={row._id} className="border-b border-[#e5e1d8] hover:bg-white/50 transition-colors">
                          <td className="py-5 px-4 font-bold text-[#b5985b]">{row.rank}</td>
                          <td className="py-5 px-4 font-bold text-[#033327]">{row.studentName}</td>
                          <td className="py-5 px-4 font-serif">{row.yearSpan}</td>
                          <td className="py-5 px-4">{row.accomplishment}</td>
                        </tr>
                      ))}
                      {/*
                      <tr className="border-b border-[#e5e1d8] hover:bg-white/50 transition-colors">
                        <td className="py-5 px-4 font-bold text-[#b5985b]">
                          2ND
                        </td>
                        <td className="py-5 px-4 font-bold text-[#033327]">
                          Fikre Bekele
                        </td>
            ...
            <div className="max-w-3xl mx-auto mb-10">
              <div className="bg-white border border-[#e5e1d8] rounded-[2.5rem] p-12 text-center relative shadow-sm">
                ...
                <h2 className="font-serif text-[1.75rem] font-bold text-[#033327] mb-4">
                  Contribute to the Living Archive
                </h2>
                <p className="text-[11px] text-gray-500 leading-relaxed max-w-md mx-auto mb-10">
                  Do you have an old photograph, a textbook from the 60s, or a
                  memory? Help us build the most comprehensive digital archive
                  of Agaro High School's legacy.
                </p>
          ...
          <div className="bg-[#FAF8F5] rounded-2xl w-full max-w-2xl max-h-[85vh] overflow-hidden flex flex-col shadow-2xl animate-in fade-in zoom-in duration-200">
            ...
            <div className="p-8 overflow-y-auto flex-1 text-[#1a1a1a]">
              <div className="flex items-center gap-4 mb-8">
                <div className="w-16 h-16 rounded-full overflow-hidden shadow-sm border border-[#e5e1d8]">
                  <img
                    src={featuredAlumnus?.imageUrl || school?.heroImageUrl}
                    className="w-full h-full object-cover grayscale opacity-90"
                    alt={featuredAlumnus?.fullName || "Historical profile"}
                  />
                </div>
                <div>
                  <h4 className="font-serif text-lg font-bold text-[#033327]">
              ...
              <div className="space-y-6 font-serif leading-relaxed text-[15px] text-gray-700">
                <p>
                  "When we laid the first stone for Agaro High School, it was
                  not merely brick and mortar we were assembling, but the very
                  scaffolding of a future society. I watched the first cohort of
                  students walk through those wooden gates, their faces a
                  mixture of trepidation and boundless hope."
                </p>
                <p>
                  "True education transcends the classroom. It is the steadying
                  force that shapes a nation, and the gentle hand that guides an
                  individual. I have always believed that if we teach them to
                  question the world with courage, they will rebuild it with
                  compassion."
                </p>
                <p>
                  "There were days when the funds ran low, when the rains
                  flooded the lower courtyards, and when political tides
                  threatened our autonomy. But the spirit of Agaro was never
                  confined to its walls. It lives in the relentless intellectual
                  curiosity of our youth. To them, I dedicate my life's work."
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="p-0 overflow-y-auto flex-1">
              <table className="w-full text-[11px] text-left">
                <thead className="bg-[#FAF8F5] border-b border-[#e5e1d8] sticky top-0 z-10">
                  <tr>
                    <th className="py-4 px-6 font-bold text-gray-500 uppercase tracking-widest">
                      Rank
                    </th>
                    <th className="py-4 px-6 font-bold text-gray-500 uppercase tracking-widest">
                      Student Name
                ...
                <tbody className="text-gray-600">
                  {honorRoll.map((row) => (
                    <tr key={row._id} className="border-b border-[#e5e1d8] hover:bg-[#FAF8F5] transition-colors">
                      <td className="py-5 px-6 font-bold text-[#b5985b]">{row.rank}</td>
                      <td className="py-5 px-6 font-bold text-[#033327] text-sm">{row.studentName}</td>
                      <td className="py-5 px-6 font-serif text-sm">{row.yearSpan}</td>
                      <td className="py-5 px-6 text-[12px]">{row.accomplishment}</td>
                    </tr>
                  ))}
                  {/*
                  Legacy records are intentionally removed; records come from the API.
                  [
                    {
                      rank: "1ST",
                      name: "Ephrem Tilahun",
                      years: "1974 - 1978",
                      desc: "AAU, Doctor of Philosophy",
                    },
                    {
                      rank: "2ND",
                      name: "Fikre Bekele",
                      years: "1982 - 1986",
                      desc: "Space Aviation College",
                    },
                    {
                      rank: "3RD",
                      name: "Abebe Worku",
                      years: "1995 - 1999",
                      desc: "Cambridge Univ, Engineering",
                    },
                    {
                      rank: "4TH",
                      name: "Samuel Tadesse",
                      years: "2001 - 2005",
                      desc: "Harvard University, Public Health",
                    },
                    {
                      rank: "5TH",
                      name: "Almaz Zewde",
                      years: "2006 - 2010",
                      desc: "Oxford Univ, International Law",
                    },
                    {
                      rank: "6TH",
                      name: "Kaleb Getachew",
                      years: "2012 - 2016",
                      desc: "Tech Entrepreneur, Forbes 30 under 30",
                    },
                    {
                      rank: "7TH",
                      name: "Sara Yosef",
                      years: "2017 - 2021",
                      desc: "National Journalism Award Winner",
                    },
                    {
                      rank: "8TH",
                      name: "Lila Vance",
                      years: "2022 - Present",
                      desc: "Rhodes Scholar Candidate",
                    },
                  ].map((row, i) => (
                    <tr
                      key={i}
                      className="border-b border-[#e5e1d8] hover:bg-[#FAF8F5] transition-colors"
                    >
                      <td className="py-5 px-6 font-bold text-[#b5985b]">
                        {row.rank}
                      </td>
                      <td className="py-5 px-6 font-bold text-[#033327] text-sm">
                        {row.name}
                      </td>
                      <td className="py-5 px-6 font-serif text-sm">
                        {row.years}
                      </td>
          ...
          <div className="bg-white rounded-2xl w-full max-w-md overflow-hidden flex flex-col shadow-2xl animate-in fade-in zoom-in duration-200">
            ...
            <form
              onSubmit={(e) => {
                ...
                alert(
                  "Thank you! Your artifact donation request has been submitted to the archives department.",
                );
              }}
            ...
            >
              ...
              <div>
                ...
                <textarea
                  required
                  rows="3"
                  placeholder="Tell us about the artifact and its significance..."
              ...
              <div className="pt-4">
                <button
                  type="submit"
                  className="w-full py-3 rounded-lg font-bold text-[11px] text-white bg-[#033327] uppercase tracking-[0.2em] hover:bg-[#044a38] transition-colors"
                >
          ...
          <div className="bg-white rounded-2xl w-full max-w-lg overflow-hidden flex flex-col shadow-2xl animate-in fade-in zoom-in duration-200">
            ...
            <form
              onSubmit={(e) => {
                ...
                alert(
                  "Thank you! Your story has been submitted for review by the archives team.",
                );
              }}
              className="p-6 space-y-4"
            >
              ...
              <div>
                ...
                <input
                  required
                  type="text"
                  placeholder="A day in the Great Hall..."
                  className="w-full p-2.5 bg-[#FAF8F5] border border-[#e5e1d8] rounded-lg text-sm focus:outline-none focus:border-[#033327] transition-colors"
                />
              </div>
              <div>
              ...
              <div className="pt-4">
                <button
                  type="submit"
                  className="w-full py-3 rounded-lg font-bold text-[11px] text-[#033327] bg-[#b5985b] uppercase tracking-[0.2em] hover:bg-[#cba86b] transition-colors"
                >
                  Submit to Archives
                </button>
              </div>
