...
const ALUMNI_DATA = [
  ...
  },
  {
    ...
    img: 'https://images.unsplash.com/photo-1580894742597-87bc8789db3d?auto=format&fit=crop&q=80&w=800',
  },
  {
...
const FIELDS = ['All', 'Science & Medicine', 'Public Affairs', 'Technology & Business', 'Fine Arts']
  ...
  const filteredAlumni = useMemo(() => {
    let result = ALUMNI_DATA.filter(alumnus => {
      ...
      if (activeField === 'Science & Medicine') {
        matchesField = alumnus.field === 'Quantum Physics' || alumnus.field === 'Medicine' || alumnus.field === 'Environmental Science'
    ...
    <div className="bg-[#FAF8F5] min-h-screen text-[#1a1a1a]">
      ...
      <div className="bg-[#0e0e0e] py-24 px-6 relative overflow-hidden">
        <div className="absolute inset-0 z-0 opacity-20">
          <img src="https://images.unsplash.com/photo-1523050854058-8df90110c9f1?auto=format&fit=crop&q=80&w=1920" alt="Background" className="w-full h-full object-cover" />
        </div>
        <div className="max-w-6xl mx-auto relative z-10 text-center">
          <p className="text-[10px] font-bold text-[#FFDEA4] uppercase tracking-[0.25em] mb-4">Honorary Records</p>
          <h1 className="font-serif text-5xl md:text-[4rem] font-bold text-white mb-6 tracking-tight">Alumni Network</h1>
          <p className="text-sm text-white/70 italic max-w-2xl mx-auto font-serif leading-relaxed">
            Celebrating the legacy of our graduates who continue to shape the world across various disciplines.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 pb-24">
        ...
        {filteredAlumni.length === 0 ? (
          <div className="text-center py-24 bg-white rounded-2xl border border-[#e5e1d8] shadow-sm">
            ...
            <h3 className="font-serif text-2xl font-bold text-[#033327] mb-2">No alumni found</h3>
            <p className="text-gray-500">Try adjusting your search terms or filters.</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredAlumni.map((alumnus, idx) => (
              <div key={idx} className="bg-white border border-[#e5e1d8] rounded-[2rem] overflow-hidden hover:shadow-xl hover:border-[#b5985b] transition-all duration-300 group flex flex-col h-full">
                <div className="relative aspect-[4/3] overflow-hidden">
                  ...
                  />
                  <div className="absolute top-4 left-4 z-10 px-3 py-1.5 bg-[#033327]/80 backdrop-blur-md text-white text-[10px] font-bold uppercase tracking-widest rounded-full shadow-md">
                ...
                <div className="p-8 flex flex-col flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    <h3 className="font-serif text-2xl font-bold text-[#033327] leading-tight">
                      {alumnus.name}
                    </h3>
                    <Award className="text-[#b5985b]" size={18} />
                  </div>
                  
                  <p className="text-[11px] font-bold text-[#b5985b] uppercase tracking-widest mb-6">
                    {alumnus.field}
                  </p>
                  
                  <p className="text-sm text-gray-600 line-clamp-4 mb-8 leading-relaxed flex-1">
                    {alumnus.desc}
                  </p>
      ...
      <section className="bg-[#1b4335] py-20 px-6 text-center text-white relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          <h2 className="font-serif text-4xl font-bold mb-4">Are you a former student?</h2>
          <p className="text-sm text-white/80 leading-relaxed mb-8 max-w-xl mx-auto">
            We are always looking to reconnect with our alumni. Update your contact information to stay informed.
          </p>
