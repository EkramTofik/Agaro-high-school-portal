...
import { ArrowRight, Book, Lightbulb, PenTool, MessageSquare, Trophy, Calendar, Landmark, Cpu, Leaf, ChevronLeft, ChevronRight } from 'lucide-react'

const clubsData = [
  {
    icon: Book,
    title: "Heritage Club",
    description: "Preserving the rich oral and cultural histories of Agaro. Illuminating our physical archives for future generations.",
    role: "PATRON",
    name: "Wzro. Almaz",
  ...
  },
  {
    ...
    description: "A space for hands-on discovery and STEM advocacy, incubating young inventors for real-world solutions.",
    role: "COORDINATOR",
    name: "Ato Kaleb",
  ...
  },
  {
    ...
    description: "The voice of The Agaro Record. Our student journalists chronicle campus life and creative poetry.",
    role: "EDITOR",
    name: "Sara Yosef",
  ...
  },
  {
    icon: MessageSquare,
    title: "Debate Club",
    description: "Sharpening logic and rhetoric. The heart of intellectual discourse and public speaking excellence.",
    role: "CHAIR",
    name: "Elias Mulu",
  ...
  },
  {
    ...
    description: "Building the future through automation. Students design, program, and compete in national robotics leagues.",
    role: "LEAD ENGINEER",
    name: "Aman Tadesse",
  ...
  },
  {
    icon: Leaf,
    title: "Eco-Warriors",
    description: "Leading campus sustainability initiatives. Dedicated to environmental conservation and green energy awareness.",
    role: "ADVISOR",
    name: "Mr. Dawit",
    ...
    <div className="bg-[#FAF8F5] min-h-screen text-[#1a1a1a]">
      ...
      <section className="relative h-[85vh] flex flex-col justify-center px-6 md:px-16 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mt-20">
          <p className="text-[10px] font-bold text-[#FFDEA4] uppercase tracking-[0.2em] mb-4">STUDENT LIFE AT AGARO</p>
          ...
          <p className="text-white/90 text-sm md:text-base leading-relaxed max-w-lg mb-10 font-serif">
            Forging character and community through our clubs, societies, and the relentless pursuit of excellence.
          </p>
          <Link to="/about#archives" className="inline-flex items-center gap-2 bg-[#033327] text-white px-8 py-3.5 rounded-lg text-[10px] font-bold uppercase tracking-[0.2em] hover:bg-[#0d4a3b] transition-colors shadow-lg">
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="font-serif text-3xl font-bold text-[#033327] mb-3">Clubs &amp; Organizations</h2>
          <p className="text-[10px] text-gray-500 uppercase tracking-widest font-bold">Cultivating Passion, Intellectual Curiosity, and Leadership</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 relative">
          {displayedClubs.map((club, index) => {
            ...
            return (
              <div key={`${club.title}-${activeClubIndex}`} className="bg-[#FAF8F5] border border-[#e5e1d8] rounded-[2rem] p-8 flex flex-col hover:border-[#b5985b] transition-colors shadow-[inset_0_2px_4px_rgba(255,255,255,1),0_2px_10px_rgba(0,0,0,0.02)] animate-in fade-in slide-in-from-right-4 duration-500">
                <div className="text-[#b5985b] mb-6"><Icon size={20} /></div>
                <h3 className="font-serif text-xl font-bold text-[#033327] mb-4">{club.title}</h3>
                <p className="text-[11px] text-gray-500 leading-relaxed flex-1 mb-8">{club.description}</p>
                <div className="flex items-center gap-3 pt-4 border-t border-[#e5e1d8]">
                  <div className="w-8 h-8 rounded-full bg-gray-200 shrink-0">
                    <img src={club.image} className="w-full h-full rounded-full object-cover grayscale" alt={club.name} />
                  </div>
                  <div>
                    <p className="text-[7px] font-bold text-gray-400 uppercase tracking-widest mb-0.5">{club.role}</p>
                    <p className="text-[10px] font-bold text-[#033327] whitespace-nowrap">{club.name}</p>
                  </div>
                </div>
              </div>
            );
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
            <div className="max-w-xl">
              ...
              <p className="text-[13px] text-white/70 leading-relaxed font-serif italic">
                Our varsity teams embody the grit and grace of the Agaro spirit. From the pitch to the track, we compete with honor.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-16">
            <div className="relative rounded-2xl overflow-hidden h-[450px] group shadow-lg">
              ...
              <div className="absolute bottom-8 left-8 right-8">
                <h3 className="font-serif text-2xl font-bold mb-2">Varsity Football</h3>
                <p className="text-[9px] font-bold text-[#FFDEA4] uppercase tracking-[0.2em]">Regional Champions 2023</p>
              </div>
            </div>
            <div className="relative rounded-2xl overflow-hidden h-[450px] group shadow-lg">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#033327] via-black/20 to-transparent"></div>
              <div className="absolute bottom-8 left-8 right-8">
                <h3 className="font-serif text-2xl font-bold mb-2">Athletics</h3>
                <p className="text-[9px] font-bold text-[#FFDEA4] uppercase tracking-[0.2em]">National Record, 400m Relay</p>
              </div>
            </div>
            <div className="relative rounded-2xl overflow-hidden h-[450px] group shadow-lg">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#033327] via-black/20 to-transparent"></div>
              <div className="absolute bottom-8 left-8 right-8">
                <h3 className="font-serif text-2xl font-bold mb-2">Volleyball</h3>
                <p className="text-[9px] font-bold text-[#FFDEA4] uppercase tracking-[0.2em]">The Grand Slams '22</p>
              </div>
            </div>
          </div>
          ...
          <div className="border border-white/10 bg-white/5 rounded-3xl p-10 md:p-14 relative overflow-hidden backdrop-blur-sm">
            <div className="flex items-center gap-3 mb-10 justify-center md:justify-start">
              ...
              <h3 className="font-serif text-xl font-bold text-[#FFDEA4]">The Trophy Room</h3>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-10 text-center">
              <div>
                <div className="w-14 h-14 rounded-full bg-[#FFDEA4] text-[#033327] font-serif font-bold text-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-black/20">24</div>
                <p className="text-[9px] font-bold uppercase tracking-[0.2em] text-white/80">Inter-High Cup</p>
              </div>
              <div>
                <div className="w-14 h-14 rounded-full bg-[#FFDEA4] text-[#033327] font-serif font-bold text-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-black/20">12</div>
                <p className="text-[9px] font-bold uppercase tracking-[0.2em] text-white/80">League Shield</p>
              </div>
              <div>
                <div className="w-14 h-14 rounded-full bg-[#FFDEA4] text-[#033327] font-serif font-bold text-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-black/20">08</div>
                <p className="text-[9px] font-bold uppercase tracking-[0.2em] text-white/80">Most Improved Team</p>
              </div>
              <div>
                <div className="w-14 h-14 rounded-full bg-[#FFDEA4] text-[#033327] font-serif font-bold text-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-black/20">07</div>
                <p className="text-[9px] font-bold uppercase tracking-[0.2em] text-white/80">Centennial Excellence</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
          ...
          <div className="lg:col-span-8 flex flex-col">
            {[
              ...
              { month: 'JAN', day: '15', title: 'Graduation Ceremony', desc: 'Celebrating the Class of 2024. A formal commencement in the Great Hall.' }
            ].map((event, i) => (
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            <div className="flex flex-col gap-4 md:gap-6">
              <div className="rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                <img src="https://images.unsplash.com/photo-1577896851231-70ef18881754?auto=format&fit=crop&q=80&w=400" className="w-full h-48 object-cover" alt="Gallery 1" />
              </div>
              <div className="rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                <img src="https://images.unsplash.com/photo-1544835619-798eb4bb8be9?auto=format&fit=crop&q=80&w=400" className="w-full h-64 object-cover" alt="Gallery 2" />
              </div>
            </div>
            <div className="flex flex-col gap-4 md:gap-6 pt-0 md:pt-12">
              <div className="rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                <img src="https://images.unsplash.com/photo-1502086223501-7ea6ecd79368?auto=format&fit=crop&q=80&w=400" className="w-full h-80 object-cover" alt="Gallery 3" />
              </div>
              <div className="rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                <img src="https://images.unsplash.com/photo-1523240795612-9a054b0db644?auto=format&fit=crop&q=80&w=400" className="w-full h-40 object-cover" alt="Gallery 4" />
              </div>
            </div>
            <div className="flex flex-col gap-4 md:gap-6">
              <div className="rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                <img src="https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?auto=format&fit=crop&q=80&w=400" className="w-full h-64 object-cover" alt="Gallery 5" />
              </div>
              <div className="rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                <img src="https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&q=80&w=400" className="w-full h-48 object-cover" alt="Gallery 6" />
              </div>
            </div>
            <div className="flex flex-col gap-4 md:gap-6 pt-0 md:pt-12">
              <div className="rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                <img src="https://images.unsplash.com/photo-1548345680-f5475ea5df84?auto=format&fit=crop&q=80&w=400" className="w-full h-40 object-cover" alt="Gallery 7" />
              </div>
              <div className="rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                <img src="https://images.unsplash.com/photo-1466692476868-aef1dfb1e735?auto=format&fit=crop&q=80&w=400" className="w-full h-80 object-cover" alt="Gallery 8" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-[#F6F4EB] rounded-[3rem] p-12 md:p-20 border border-[#e5e1d8] shadow-sm">
            ...
            <div className="space-y-12 max-w-2xl mx-auto">
              <div>
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h4 className="text-[10px] font-bold text-[#033327] uppercase tracking-[0.2em]">I. THE RIGHT TO INQUIRY</h4>
                </div>
              ...
              <div>
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-1.5 h-1.5 bg-[#b5985b] rotate-45"></div>
                  <h4 className="text-[10px] font-bold text-[#033327] uppercase tracking-[0.2em]">II. THE BURDEN OF INTEGRITY</h4>
                </div>
              ...
              <div>
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-1.5 h-1.5 bg-[#b5985b] rotate-45"></div>
                  <h4 className="text-[10px] font-bold text-[#033327] uppercase tracking-[0.2em]">III. STEWARDSHIP OF LEGACY</h4>
                </div>
            ...
            <div className="mt-20 pt-10 border-t border-[#e5e1d8] text-center">
              <p className="text-[10px] text-gray-500 font-serif italic leading-relaxed">
                Adopted by the Agaro Board of Trustees, September 1954<br/>
