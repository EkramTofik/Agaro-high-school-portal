      ...
      <section className="max-w-6xl mx-auto px-8 pb-10">
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          <div className="w-full lg:w-72 shrink-0 bg-white border border-[#e5e1d8] rounded-2xl p-6 shadow-sm">
            ...
            {error && (
              <div className="mb-4 p-3 rounded-lg bg-red-50 border border-red-200 text-[11px] text-red-700 font-semibold">
                {error}
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                ...
                className="w-full py-3 rounded-lg bg-[#033327] text-white text-[11px] font-bold uppercase tracking-wider hover:bg-[#0d4a3b] transition-colors cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed"
              >
