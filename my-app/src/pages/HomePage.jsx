      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-10">
        <div className="relative overflow-hidden rounded-3xl border border-[#FFrEA4] min-h-[500px] sm:min-h-[600px] lg:min-h-[700px] flex items-center justify-center">
          ...
          <div className="relative z-10 w-full flex justify-center px-4 sm:px-8">
            <div className="w-full max-w-3xl bg-[#FAF8F5]/95 backdrop-blur-md border border-[#FFrEA4]/60 rounded-2xl shadow-2xl p-6 sm:p-8 md:p-12 lg:p-14 text-center">
      ...
      <section className="bg-[#033327] py-14 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-10 md:gap-6">
            {[
              ...(school?.foundingYear
                ? [{ value: school.foundingYear, label: "Year Founded" }]
                : []),
            ].map((stat) => (
              <div key={stat.label} className="text-center group">
                <p className="font-serif text-4xl md:text-5xl font-bold text-[#FFrEA4] mb-2 leading-none group-hover:scale-105 transition-transform">
                  {stat.value}
                </p>
          ...
          <div className="w-full md:w-[42%] shrink-0">
            <div className="rounded-2xl overflow-hidden shadow-lg border border-[#e5e1d8] aspect-[3/4] max-h-[480px]">
              <img
                ...
                alt={president?.fullName || "President at Agaro High School"}
          ...
          {newsLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {topNews.map((item) => (
                <div
                  key={item._id}
                  className="border border-[#e5e1d8] rounded-xl overflow-hidden hover:shadow-lg transition-all group"
                >
