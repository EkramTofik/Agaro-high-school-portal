...
const navGroups = [
  {
    title: "Overview",
    items: [{ to: "/admin/dashboard", label: "Dashboard", icon: Icon.home, end: true }],
  },
  {
    title: "People",
    items: [
      ...
      { to: "/admin/student-voices", label: "Student Voices", icon: Icon.voice },
  ...
  },
  {
    title: "Academics",
    items: [
      { to: "/admin/academic-records", label: "Academic Records", icon: Icon.doc },
      { to: "/admin/resources", label: "Resources", icon: Icon.resource },
      { to: "/admin/departments", label: "Departments", icon: Icon.school },
      { to: "/admin/academic-years", label: "Academic Years", icon: Icon.calendar },
        ...
        <header className="flex shrink-0 items-center justify-between gap-4 border-b border-[#e5e1d8] bg-[#FAF8F5] px-6 py-3">
          ...
          >
            ...
            <div className="text-left">
              <p className="text-[11px] font-bold text-[#1a1a1a]">{user?.fullName || "Admin"}</p>
              <p className="text-[8px] uppercase tracking-widest text-gray-500">Edit profile</p>
            </div>
