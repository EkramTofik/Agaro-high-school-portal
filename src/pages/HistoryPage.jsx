          ...
          <section id="hall-of-fame" className="mb-24 lg:mb-32 pt-8">
            <div className="text-center mb-16 max-w-2xl mx-auto">
              ...
              <p className="text-[13px] text-gray-500 italic font-serif leading-relaxed max-w-xl mx-auto">
                Throughout its history, Agaro has seen leaders, scholars, and
            ...
            <div className="flex flex-col md:flex-row rounded-[2rem] overflow-hidden max-w-4xl mx-auto shadow-[0_4px_20px_rgba(0,0,0,0.05)] border border-[#e5e1d8]">
              ...
              <div className="md:w-1/2 bg-[#dce8de] p-10 md:p-12 flex flex-col justify-center">
                ...
                <p className="text-[11px] text-[#033327]/80 leading-relaxed mb-8">
                  Dr. Selamawit Bekele founded Agaro High School with the vision
          ...
          <section id="alumni" className="mb-24 lg:mb-32 pt-8">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                {[
                  {
                    name: "Ato Mulu Getahun",
                    role: "MINISTER OF EDUCATION (1998)",
                    desc: "Spearheaded regional education reform policies with a vision heavily influenced by his formative years at Agaro High.",
                    img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=300",
                  },
                  {
                    name: "Wzro. Tigist S.",
                    role: "CEO, PAN-AFRICAN BANK",
                    desc: "Starting from the Agaro commerce club, she went on to redefine financial empowerment across the continent.",
                    img: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&w=300",
                  },
                  {
                    name: "Dr. Dawit Bekele",
                    role: "MEDICAL RESEARCHER",
                    desc: "A global innovator in epidemiology, leading research initiatives that continue to save millions of lives.",
                ...
                <div className="flex flex-col md:flex-row items-center gap-10 md:gap-14">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-gray-500 leading-relaxed max-w-xl">
                      Ato Kaleb's tenure saw Agaro High School win the National
                      Science Fair three times. His rigorous methodology
                      continues to influence the modern curriculum, blending
                      deep theoretical frameworks with hands-on practice.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row-reverse items-center gap-10 md:gap-14 md:text-right">
                  ...
                  <div className="flex flex-col md:items-end">
                    ...
                    <p className="font-serif italic text-sm text-[#033327] leading-relaxed mb-5 md:border-r-2 md:border-l-0 border-l-2 border-[#b5985b] md:pr-4 pl-4 md:pl-0">
                      "The soul of our history is carried in the tongue of our
                      ancestors. To speak well is to think clearly."
                    </p>
                    <p className="text-[11px] text-gray-500 leading-relaxed max-w-xl">
                      Spearheading the linguistic arts division, Wzro. Almaz
                      instilled a passion for both local dialects and global
                      literature, bridging the gap between traditional wisdom
