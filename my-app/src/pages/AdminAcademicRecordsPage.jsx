...
export default function AdminAcademicRecordsPage() {
  ...
  const saveRecord = async (values) => {
    setSaving(true)
    try { await (formRecord?._id ? api.patch(`/academicRecord/${formRecord._id}`, values) : api.post('/academicRecord', values)); setFormRecord(null); await loadRecords() }
    catch (e) { setError(e.response?.data?.message || 'Could not save academic record.') }
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-start justify-between mb-10 pb-10 border-b border-[#e5e1d8]">
              ...
              {(loading || error || records.length === 0) && (
                <p className={error ? "mb-6 text-sm text-red-500" : "mb-6 text-sm text-gray-500"}>
                  {loading ? "Loading academic records…" : error || "No academic records found."}
                </p>
              )}
              <div className="flex items-center gap-3 mt-2">
                ...
                <button onClick={addRecord} className="px-6 py-2.5 rounded-md bg-[#033327] text-[11px] font-bold text-white hover:bg-[#0d4a3b] transition-colors flex flex-col items-center justify-center gap-1">
              ...
              <div className="lg:col-span-5 space-y-6">
                ...
                <div className="bg-white border border-[#e5e1d8] rounded-xl p-6 relative">
                  ...
                  <div className="flex items-center gap-4 text-[10px] text-gray-500 mb-6">
                    ...
                    <span className="flex items-center gap-1">{icons.fileText} PDF â€¢ 13.4MB</span>
                  </div>
                ...
                <div className="bg-white border border-[#e5e1d8] rounded-xl p-6 relative">
                  ...
                  <div className="flex items-center gap-4 text-[10px] text-gray-500 mb-6">
                    <span className="flex items-center gap-1"><span className="w-1.5 h-1.5 rounded-full bg-green-500"></span> Published</span>
                    <span className="flex items-center gap-1">{icons.fileText} Excel â€¢ 2.1MB</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <button className="flex-1 py-2.5 rounded bg-[#033327] text-white text-[10px] font-bold uppercase tracking-wider hover:bg-[#0d4a3b] flex items-center justify-center gap-2">
                ...
                <div className="bg-white border border-[#e5e1d8] rounded-xl p-6 relative">
                  ...
                  <div className="flex items-center gap-4 text-[10px] text-gray-400 mb-6">
                    ...
                    <span className="flex items-center gap-1">{icons.fileText} PDF â€¢ 10.8MB</span>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="bg-[#033327] rounded-xl p-6 relative overflow-hidden text-white">
                    ...
                    <div className="flex items-end gap-4 mb-4">
                      <h3 className="font-serif text-[42px] font-bold leading-none">{records.length}</h3>
                  ...
                  <div className="bg-[#fcfbfa] border border-[#e5e1d8] rounded-xl p-6 relative">
                    ...
                    <h3 className="font-serif text-[42px] font-bold text-[#1a1a1a] leading-none mb-4">—</h3>
