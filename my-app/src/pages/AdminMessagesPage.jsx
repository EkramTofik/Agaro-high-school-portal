        ...
        <div className="px-10 py-8">
          ...
          <div className="flex items-start justify-between mb-6">
            ...
            {(loading || error || messages.length === 0) && (
              <p className={error ? "mb-4 text-sm text-red-500" : "mb-4 text-sm text-gray-500"}>
                {loading ? "Loading messages…" : error || "No contact messages received."}
              </p>
            )}
          ...
          <div className="grid grid-cols-12 gap-5 mb-8 h-[500px]">
            ...
            <div className="col-span-6 bg-white border border-[#e5e1d8] rounded-xl flex flex-col relative overflow-hidden">
              ...
              <div className="shrink-0 p-6 pt-2 flex items-center justify-center gap-3">
                <button onClick={() => updateStatus('replied')} className="px-6 py-2.5 rounded bg-[#033327] text-[11px] font-bold text-white tracking-wider hover:bg-[#0d4a3b] transition-colors flex items-center gap-2">
                ...
                <button onClick={() => updateStatus('read')} className="px-4 py-2.5 rounded bg-white border border-[#033327] text-[11px] font-bold text-[#033327]">Mark Read</button>
                <button onClick={deleteMessage} className="px-4 py-2.5 rounded bg-white border border-red-300 text-[11px] font-bold text-red-600">Delete</button>
              </div>
            </div>
          ...
          <div className="flex items-end justify-between">
            <div className="flex items-center gap-8">
              <div>
                <p className="font-serif text-[32px] font-bold text-[#033327] leading-none mb-1">{messages.length}</p>
                <p className="text-[8px] font-bold text-gray-500 uppercase tracking-widest">Total Oct Submissions</p>
              </div>
              <div>
                <p className="font-serif text-[32px] font-bold text-[#b5985b] leading-none mb-1">—</p>
