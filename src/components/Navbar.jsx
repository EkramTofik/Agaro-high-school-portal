      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-6">
            <button className="text-[#033327] hover:text-[#0d4a3b] transition-colors">
              <Search size={18} strokeWidth={2.5} />
            </button>
            <Link
              to="/contact"
              id="nav-enroll-btn"
              className="px-6 py-2 bg-[#033327] hover:bg-[#0d4a3b] text-white font-bold text-[10px] uppercase tracking-widest rounded-full transition-all duration-200 shadow-sm"
            >
              Enroll
            </Link>
          </div>
