    ...
    <div className="bg-[#FAF8F5] min-h-[80vh] flex items-center justify-center px-6 py-20 text-[#1a1a1a]">
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="relative inline-block mb-6">
          <h1 className="font-serif text-8xl md:text-9xl font-bold text-[#033327] opacity-10">
            404
          </h1>
          <div className="absolute inset-0 flex items-center justify-center">
            <h2 className="font-serif text-3xl md:text-4xl font-bold text-[#033327]">
              Page Not Found
            </h2>
          </div>
        </div>
        ...
        <p className="text-gray-600 mb-8 max-w-lg mx-auto leading-relaxed">
          ...
          changed, or is temporarily unavailable in our archives.
        </p>
